...
export class FaqPage implements OnInit {
  ...
  constructor(private navCtrl : NavController, public storage: Storage) {
    this.faqClientContent = [
      ...
      {title : "Comment les bars sont sélectionnés ?", text: "Nous avons fait une sélection d’excellent bars, pubs, cafés, etc... Une offre diversifiée d’établissement vous est proposée afin de correspondre aux gouts de chacun. Nous nous sommes assurés que vous bénéficierez d’un service et de boissons de grande qualité."},
